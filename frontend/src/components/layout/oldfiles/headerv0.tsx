...
import { Search, ShoppingCart, User, Menu, X, BookOpen, Heart, ToggleRight, ToggleLeft } from "lucide-react"
...
export default function Headerv0() {
    ...
    // In a real app, you would check authentication state from context/store
    // useEffect(() => {
    //     // Example: Check session storage or local auth state
    ...
    //     // Optional: set up listener for auth state changes
    ...
    return (
        ...
        >
            {/* Add login state toggle for testing */}
            <div className="fixed bottom-4 right-4 z-50 bg-primary/20 backdrop-blur-md rounded-full p-2 shadow-lg flex items-center gap-2">
